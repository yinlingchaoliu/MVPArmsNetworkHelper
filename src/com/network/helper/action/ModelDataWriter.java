 ...
 *  Api插入文件
 */
public class ModelDataWriter extends WriteCommandAction {
    private Project project;
    private PsiFile psiFile;
    private PsiClass psiClass;
    private NetWorkEntity entity;

    public ModelDataWriter(@NotNull PsiFile psiFile, NetWorkEntity entity){
    ...
    private ModelDataWriter(@Nullable Project project, PsiFile... files) {
        super(project, files);
    }
    ...
    private void write(){
        ...
        String  content = ArmConstant.getModelStr(entity);
