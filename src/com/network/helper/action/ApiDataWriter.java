 ...
 *  Api插入文件
 */
public class ApiDataWriter extends WriteCommandAction {
    private Project project;
    private PsiFile psiFile;
    private PsiClass psiClass;
    private NetWorkEntity entity;

    public ApiDataWriter(@NotNull PsiFile psiFile, NetWorkEntity entity){
    ...
    private ApiDataWriter(@Nullable Project project, PsiFile... files) {
        super(project, files);
    }
    ...
    private void write(){
        ...
        String  content = ArmConstant.getApiString(entity);
