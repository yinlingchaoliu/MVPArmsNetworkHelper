 ...
 *  Api插入文件
 */
public class UIDataWriter extends WriteCommandAction {
    private Project project;
    private PsiFile psiFile;
    private PsiClass psiClass;
    private NetWorkEntity entity;

    public UIDataWriter(@NotNull PsiFile psiFile, NetWorkEntity entity){
    ...
    private UIDataWriter(@Nullable Project project, PsiFile... files) {
        super(project, files);
    }
